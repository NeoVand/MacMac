...
<div bind:this={mathContainer} class="mx-auto min-h-dvh max-w-xl px-6 py-8 sm:px-10 sm:py-12">
	...
	<div class="space-y-4 text-[13px] leading-relaxed" style="color: var(--text-secondary);">
		...
		<!-- Footer -->
		<div class="mt-6 flex flex-col gap-3 pt-5" style="border-top: 1px solid var(--border);">
			<div class="text-xs" style="color: var(--text-tertiary);">
				Created by <span style="color: var(--text-secondary);">Neo Mohsenvand</span>
			</div>
			<div class="flex gap-4">
				<a href="https://github.com/NeoVand/MacMac" target="_blank" rel="noopener" class="flex items-center gap-1.5 text-xs transition hover:opacity-70" style="color: var(--text-tertiary);">
				...
				<a href="https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo" target="_blank" rel="noopener" class="flex items-center gap-1.5 text-xs transition hover:opacity-70" style="color: var(--text-tertiary);">
