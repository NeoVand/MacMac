			...
			<div class="flex items-center justify-between">
				...
				<div class="flex items-center gap-3">
					...
					<button
						...
						class="flex h-11 items-center gap-2 rounded-xl border border-game-cyan/30 bg-game-cyan/10 px-5 text-sm font-semibold text-game-cyan transition hover:border-game-cyan/50 hover:bg-game-cyan/15 active:scale-95 disabled:opacity-20"
					>
